...
helm upgrade --install test-openshift sumologic/sumologic \
  ...
  --set metadata.image.tag=0.114.0-sumo-0-ubi \
  ...
  --set opentelemetry-operator.manager.collectorImage.tag=0.114.0-sumo-0-ubi \
  ...
  --set otelcolInstrumentation.statefulset.image.tag=0.114.0-sumo-0-ubi \
  --set otelevents.image.repository=public.ecr.aws/sumologic/sumologic-otel-collector \
  --set otelevents.image.tag=0.114.0-sumo-0-ubi \
  ...
  --set otellogs.image.tag=0.114.0-sumo-0-ubi \
  ...
  --set sumologic.metrics.collector.otelcol.image.tag=0.114.0-sumo-0-ubi \
  ...
  --set sumologic.otelcolImage.tag=0.114.0-sumo-0-ubi \
  ...
  --set tracesGateway.deployment.image.tag=0.114.0-sumo-0-ubi \
  --set tracesSampler.deployment.image.repository=public.ecr.aws/sumologic/sumologic-otel-collector \
  --set tracesSampler.deployment.image.tag=0.114.0-sumo-0-ubi
