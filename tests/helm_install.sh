...
helm upgrade --install test-openshift sumologic/sumologic \
  ...
  --set telegraf-operator.image.sidecarImage=public.ecr.aws/sumologic/telegraf-operator-ubi@sha256:88c3b5d9f8e9a419131c39e6e22c5aa7cfaab5157fe4c5cc928574f5a3cfda2c \
