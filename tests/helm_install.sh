...
helm upgrade --install test-openshift sumologic/sumologic \
  ...
  --set kube-prometheus-stack.prometheus.prometheusSpec.image.tag=v3.0.1-ubi \
  ...
  --set kube-prometheus-stack.prometheusOperator.image.tag=v0.79.1-ubi \
  ...
  --set kube-prometheus-stack.prometheusOperator.prometheusConfigReloaderImage.tag=v0.79.1-ubi \
  ...
  --set opentelemetry-operator.manager.image.tag=0.122.0-ubi \
  ...
  --set pvcCleaner.job.image.tag=d7570aaf54028d9ae699ecab56f0885bb3603b7b5e1717b3961935c2c1621365 \
