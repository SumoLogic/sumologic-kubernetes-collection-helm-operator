...
helm upgrade --install test-openshift sumologic/sumologic \
  ...
  --set metadata.image.tag=0.145.0-sumo-0 \
  --set metrics-server.image.registry=public.ecr.aws/sumologic \
  --set metrics-server.image.repository=metrics-server@sha256 \
  --set metrics-server.image.tag=aade7cec3bd8e4d92891aeec6ccb832b648324ebec8aee009b4f6c629e327582 \
  ...
  --set opentelemetry-operator.manager.collectorImage.tag=0.145.0-sumo-0 \
  ...
  --set otelcolInstrumentation.statefulset.image.tag=0.145.0-sumo-0 \
  --set otelevents.image.repository=public.ecr.aws/sumologic/sumologic-otel-collector \
  --set otelevents.image.tag=0.145.0-sumo-0 \
  ...
  --set otellogs.image.tag=0.145.0-sumo-0 \
  ...
  --set sumologic.metrics.collector.otelcol.image.tag=0.145.0-sumo-0 \
  ...
  --set sumologic.otelcolImage.tag=0.145.0-sumo-0 \
  ...
  --set tracesGateway.deployment.image.tag=0.145.0-sumo-0 \
  --set tracesSampler.deployment.image.repository=public.ecr.aws/sumologic/sumologic-otel-collector \
  --set tracesSampler.deployment.image.tag=0.145.0-sumo-0
