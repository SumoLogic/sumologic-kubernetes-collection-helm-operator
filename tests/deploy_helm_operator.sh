...
readonly IMG="${IMG:=registry.connect.redhat.com/sumologic/sumologic-kubernetes-collection-helm-operator:5.1.1-0-rc.0}"
...
sed -i.bak "s#registry.connect.redhat.com/sumologic/sumologic-kubernetes-collection-helm-operator:5.1.1-0-rc.0#${IMG}#g" bundle.yaml
