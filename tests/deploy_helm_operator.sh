...
readonly IMG="${IMG:=registry.connect.redhat.com/sumologic/sumologic-kubernetes-collection-helm-operator:4.21.0-0-rc.0}"
...
sed -i.bak "s#registry.connect.redhat.com/sumologic/sumologic-kubernetes-collection-helm-operator:4.21.0-0-rc.0#${IMG}#g" bundle.yaml
